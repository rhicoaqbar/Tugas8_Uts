                              ...
                              <div class="blog__item white-bg mb-30 transition-3 fix">
                                 <div class="blog__thumb w-img fix">
                                    <a href="{{url('blogdetail')}}">
                                       <img src="{{url('public')}}/assets/img/blog/blog-1.jpg" alt="">
                                    </a>
                                 </div>
                                 <div class="blog__content">
                                    <div class="blog__tag">
                                       <a href="#">{{$produk->stok}}</a>
                                    </div>
                                    <h3 class="blog__title"><a href="{{url('blogdetail')}}">{{$produk->deskripsi}}</a></h3>
                                    <div class="blog__meta d-flex align-items-center justify-content-between">
                                       <div class="blog__author d-flex align-items-center">
                                          <div class="blog__author-thumb mr-10">
                                             <img src="{{url('public')}}/assets/img/blog/author/author-1.jpg" alt="">
                                          </div>
                              ...
                              <div class="rc__post-wrapper">
                                 <div class="rc__post d-flex align-items-center">
                                    ...
                                    <div class="rc__content">
                                       ...
                                       <h6 class="rc__title"><a href="{{url('blogdetail')}}">{{$produk->stok}}</a></h6>
                                    </div>
                                 </div>
                                 <div class="rc__post d-flex align-items-center">
                                    <div class="rc__thumb mr-20">
                                       <a href="{{url('blogdetail')}}"><img src="{{url('public')}}/assets/img/blog/sm/blog-sm-2.jpg" alt=""></a>
                                    </div>
                                    <div class="rc__content">
                                       <div class="rc__meta">
                                          <span>{{$produk->harga}}</span>
                                 ...
                                 <div class="rc__post d-flex align-items-center">
                                    <div class="rc__thumb mr-20">
                                       <a href="{{url('blogdetail')}}"><img src="{{url('public')}}/assets/img/blog/sm/blog-sm-3.jpg" alt=""></a>
                                    </div>
                                    <div class="rc__content">
                                       <div class="rc__meta">
                                          <span>{{$produk->harga}}</span>
